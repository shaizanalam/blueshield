    ...
    <div className="bg-surface/30 min-h-screen pt-[72px]">
      ...
      <div className="container py-12">
        <div className="bg-surface p-8 sm:p-12 rounded-3xl border border-border shadow-sm max-w-4xl mx-auto space-y-6 text-sm text-text-muted leading-relaxed">
          <h2 className="text-xl font-bold text-text">1. Product Information & Pricing</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-text">2. Quotation Validity & Orders</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-text">3. Delivery & On-Site Installation</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-text">4. Jurisdiction</h2>
          <p>
